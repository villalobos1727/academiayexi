...
/*para  acrecentar mais un criterio colocar and= si quero has dois coisas, o
or= si a gente quee uma u outra*/

select nome,telefone from aluno
where 
nome like '%Souza' and nome like '%silva';
...
20) pesquisar nome e telefone de todos os personal que tiviram
aula no dia 10/12/2022.

select f.nome,f.telefone
from fuscionario f inner join professor p
on f.cpffuncionario = p.cpffuncionario
inner join aula a
...
/* para inserir comando em uma tabela */
